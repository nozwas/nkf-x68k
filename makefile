...
CFLAGS = $(COMMON_FLAGS) -Wno-builtin-declaration-mismatch -fcall-used-d2 -fcall-used-a2 -finput-charset=cp932 -fexec-charset=cp932 -fverbose-asm -D__XDEV68K__
CXXFLAGS = $(CFLAGS) -fno-rtti -fno-exceptions -std=gnu++17

# *.c ソースファイル
C_SRCS = nkf.c utf8tbl.c
